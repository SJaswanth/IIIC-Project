...
@Component({
  selector: 'app-section1icic',
  templateUrl: './section1icic.component.html',
  styleUrls: ['./section1icic.component.css']
})
export class Section1icicComponent implements OnInit {
...
verify(){
  ...
  section80cicic() {
      ...
      this.authService.section80cicic(this.section1.value).then((result) => {
