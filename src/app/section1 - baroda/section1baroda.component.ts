...
@Component({
  selector: 'app-section1baroda',
  templateUrl: './section1baroda.component.html',
  styleUrls: ['./section1baroda.component.css']
})
export class Section1barodaComponent implements OnInit {
...
verify(){
  ...
  section80cbaroda() {
      ...
      this.authService.section80cbaroda(this.section1.value).then((result) => {
