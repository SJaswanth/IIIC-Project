...
@Component({
  selector: 'app-section1sbi',
  templateUrl: './section1sbi.component.html',
  styleUrls: ['./section1sbi.component.css']
})
export class Section1sbiComponent implements OnInit {
...
verify(){
  ...
  section80csbi() {
      ...
      this.authService.section80csbi(this.section1.value).then((result) => {
