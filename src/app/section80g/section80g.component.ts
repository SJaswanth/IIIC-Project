...
@Component({
  ...
  styleUrls: ['./section80g.component.css']
})
export class Section80gComponent implements OnInit {
         ...
         // console.log('Section80c: form', form);
          ...
          if (form) {
            let emailLower = form.email.toLowerCase();
              ...
              this.form = this.firestore.collection('section80g').doc(emailLower).valueChanges();
          }
      });
