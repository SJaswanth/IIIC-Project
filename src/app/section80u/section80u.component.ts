...
@Component({
  selector: 'app-section80u',
  templateUrl: './section80u.component.html',
  styleUrls: ['./section80u.component.css']
})
export class Section80uComponent implements OnInit {
         ...
         // console.log('Section80c: form', form);
          ...
          if (form) {
            let emailLower = form.email.toLowerCase();
              ...
              this.form = this.firestore.collection('section80u').doc(emailLower).valueChanges();
          }
      });
