...
@Component({
  selector: 'app-section80c',
  templateUrl: './section80c.component.html',
  styleUrls: ['./section80c.component.css']
})
         ...
         // console.log('Section80c: form', form);
          ...
          if (form) {
            let emailLower = form.email.toLowerCase();
              ...
              this.form = this.firestore.collection('section80c').doc(emailLower).valueChanges();
          }
      });
